...
For testing, I leveraged **Node 22's built-in test runner** to support assertions and coverage. This approach keeps the solution lightweight, dependency-free, and easy to run with a single command.
